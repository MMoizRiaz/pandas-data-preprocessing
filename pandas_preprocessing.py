...
## Step 10: Creating preprocessing pipeline and saved cleaned output
# Part A Wraaping Everything into a function
...
if __name__=='__main__':
    ...
    print("\nCleaned data saved to data/cleaned_sample.csv")
